...
def load_data_multi():
    data = np.loadtxt("D:/Umama/MachineLearning/Course1/data/houses.txt", delimiter=',')
    X = data[:,:2]
    y = data[:,2]
    return X, y
...
def load_house_data():
    data = np.loadtxt("D:/Umama/MachineLearning/Course1/data/houses.txt", delimiter=',', skiprows=1)
    X = data[:,:4]
    y = data[:,4]
    return X, y
